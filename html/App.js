window.APP = {
    ...
    methods: {
        ...
        keyDown(e) {
            ...
            if (e.which == 9 && this.$refs.suggestion.currentSuggestions.length > 0) {
                e.preventDefault();
                this.message = this.$refs.suggestion.currentSuggestions[0].name;
                //console.log(this.$refs.suggestion.currentSuggestions[0].nam)
